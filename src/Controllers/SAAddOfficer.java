...
public class SAAddOfficer extends JFrame {
			...
			public void run() {
				try {
					...
					if (SystemAdministratorsController.getUser() != null) {
						SAAddOfficer frame = new SAAddOfficer();
	...
	private void initialize() {
		...
		JButton btnAddOfficer = new JButton("Add officer");
		btnAddOfficer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(	user.addParkingOfficer(firstname,lastname,email, password)) {
...
//					passwordField.setText(null);
		...
		btnAddOfficer.setBounds(171, 414, 118, 34);
		...
		JLabel lbllicencePlatenumber_1 = new JLabel("Password");
		...
		passwordField.setBounds(10, 37, 296, 39);
		p4_1.add(passwordField);
		...
		JLabel lbWelcome = new JLabel("<html>Add Officer<html>");
		...
		JLabel lblGetStarted = new JLabel("<html>Enter officer details </html>");
